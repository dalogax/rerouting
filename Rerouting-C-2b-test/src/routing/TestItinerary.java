...
public class TestItinerary {
	...
	public void truncatedAt() {
		...
		Itinerary expectedTruncated = new Itinerary(new Leg("HKG", "LGB"));
	...
	public void extendedOn() {
		Itinerary itin = new Itinerary(new Leg("HKG", "LGB"));
		...
		// it is a side-effect-free function.
		Itinerary expectedUnmodified = new Itinerary(new Leg("HKG", "LGB"));
