...
public class TestRouting {
	@Test
	public void TestInitialRouting2Legs() {
		...
		Itinerary expected = new Itinerary(new Leg("HKG", "LGB"), new Leg(
				"LGB", "DAL"));
	...
	@Test
	public void TestInitialRouting1Leg() {
		Cargo cargo = new Cargo();
		cargo.setOrigin("HKG");
	...
	public void TestRerouting() {
		...
		cargo.setOrigin("HKG");
		cargo.setDestination("DAL");
		cargo.setItinerary(new Itinerary(new Leg("HKG", "LGB"), new Leg("LGB",
				"DAL")));
