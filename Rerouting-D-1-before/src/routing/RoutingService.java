...
import acmeroutingco.*;
    public class RoutingService
    {
        ...
        {
        	if (!cargo.getItinerary().goesThrough(reroutePoint)) throw new IllegalArgumentException();
            ...
            Itinerary rerouted = cargo.getItinerary().truncatedAt(reroutePoint).extendedOn(appendedLegs);
